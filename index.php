    ...
    <div class="row">
      ...
      <div class="col-sm-5">
        ...
        <div class="media">
          ...
          <div class="media-body">
            <strong>
              <?php tre("[link: {user}] reviewed [link: {business_name}]", array("link"=>"", "user" => array("object" => array("name" => "Jane Smith", "gender" => "female"), "attribute" => "name"), "business_name" => tr("Ricky's Fish Tacos"))) ?>
            </strong>
